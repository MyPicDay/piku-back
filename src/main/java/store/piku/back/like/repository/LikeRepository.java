package store.piku.back.like.repository;
...
public interface LikeRepository extends JpaRepository<Like, Long> {
    ...
    @Query("SELECT l.diaryId FROM Like l WHERE l.userId = :userId AND l.deletedAt IS NULL")
    Set<Long> findLikedDiaryIdsByUserId(@Param("userId") String userId);
    ...
    Set<Long> findLikedDiaryIdsByUserIdAndDiaryIds(@Param("userId") String userId, @Param("diaryIds") List<Long> diaryIds);
}
