package store.piku.back.like.controller;
...
public class LikeController {
    ...
    public ResponseEntity<LikeResponse> addLike(
        ...
        LikeResponse response = likeService.addLike(userDetails.getId(), diaryId, requestMetaInfo);
    ...
    public ResponseEntity<LikeResponse> removeLike(
        ...
        LikeResponse response = likeService.removeLike(userDetails.getId(), diaryId);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<LikeResponse> getLikeStatus(
        ...
        LikeResponse response = likeService.getLikeStatus(userId, diaryId);
        return ResponseEntity.ok(response);
    }
