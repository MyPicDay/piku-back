...
public class AuthExceptionHandler {
	...
	private AuthProblemType mapProblemType(AuthErrorCode code) {
		return switch (code) {
			...
			case INVALID_EMAIL -> AuthProblemType.INVALID_EMAIL;
			case INVALID_PASSWORD -> AuthProblemType.INVALID_PASSWORD;
			case CODE_EXPIRED, CODE_MISMATCH, EMAIL_VERIFICATION_EXPIRED,
					EMAIL_VERIFICATION_ALREADY_USED -> AuthProblemType.CODE_INVALID;
		};
	}
}
