...
class NotificationPageQueryServiceIntegrationTest extends AbstractJpaQueryCountIntegrationTest {

	@Autowired
	private NotificationPageQueryService notificationPageQueryService;
	...
	void notificationQueryCountStaysBounded() {
		...
		long oneItemQueries = measurePreparedStatements(() ->
				notificationPageQueryService.queryNotifications(receiver.getId(), PageQuery.of(0, 1)));
		long threeItemQueries = measurePreparedStatements(() ->
				notificationPageQueryService.queryNotifications(receiver.getId(), PageQuery.of(0, 3)));
