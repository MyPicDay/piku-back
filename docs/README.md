...
이 디렉터리는 `piku-back`의 공식 문서 시스템이다. `AGENTS.md`는 짧은 진입 맵만 제공하고, 실제 기준 정보는 이 경로 아래 문서가 담당한다.

## 읽는 순서

1. 구조와 아키텍처는 `indexes/architecture-index.md`
...
- [Architecture](indexes/architecture-index.md)
- [Standards](indexes/standards-index.md)
...
`docs/superpowers/`는 로컬 전용 작업 문서다. 공식 기준 문서로 취급하지 않는다.
