...
이 문서는 `docs/domain-models/` 아래의 현재 기준 문서를 찾기 위한 색인이다.
...
- [Character](../domain-models/character.md): 고정·사용자별 AI 생성 캐릭터, 소유권·카탈로그와 이미지 참조
...
- [User](../domain-models/user.md): 사용자 식별, 선택된 캐릭터 식별자, 프로필 관리와 닉네임 점유
